...
public class ExecutionTreeRuleImpl extends ExecutionTreeInstantiationImpl implements ExecutionTreeRule{
	 ...
	 */
	protected ExecutionTreeRuleImpl(Rule rule, Atom head) {
