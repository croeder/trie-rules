...
public class AbductiveExecutionTreeFactsImpl extends AbductiveExecutionTreeElementImpl implements ExecutionTreeFacts {
	...
	protected AbductiveExecutionTreeFactsImpl(Atom goal,KnowledgeBase kb) {
		this.goal = goal;
